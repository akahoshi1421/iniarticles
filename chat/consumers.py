...
class ChatConsumer(WebsocketConsumer):
    ...
    def receive(self, text_data):
        ...
        result_get = Article.objects.get(room_name = room)
        result_get.text = message
        result_get.save()
    ...
    def chat_message(self, event):
        ...
        message = result_get.text
        # Send message to WebSocket
        self.send(text_data=json.dumps({'message': message, "message_markdown": markdown.markdown(message)}))